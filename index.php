    ...
    <header class="hero">
        <div class="container hero-grid">
            ...
            <div class="relative">
                ...
                <img alt="HydroFlow Systems" class="relative z-10 editorial-shadow" style="border-radius: 2.5rem; object-fit: cover; width: 100%; height: 500px;" src="<?= BASE_URL ?>assets/images/landing/hero.png"/>
