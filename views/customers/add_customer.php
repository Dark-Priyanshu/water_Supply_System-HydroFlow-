...
<div class="flex" style="justify-content: space-between; align-items: flex-end; margin-bottom: 2rem; margin-top: 1rem;">
    <div>
        ...
        <h2 style="font-size: 1.875rem; font-family: var(--font-headline); font-weight: 800; color: var(--color-on-surface); letter-spacing: -0.025em; margin-bottom: 0.5rem;"><?= __('add_new_customer') ?></h2>
        <p style="font-size: 1rem; color: var(--color-on-surface-variant); max-width: 40rem;"><?= __('add_customer_desc') ?></p>
    </div>
...
<div class="form-card">
    <div class="form-body">
        <form action="../../controllers/customerController.php" method="POST">
            <h4 style="font-family: var(--font-headline); font-size: 1.125rem; font-weight: 700; color: var(--color-on-surface); margin-bottom: 1.5rem; border-bottom: 1px solid rgba(112, 120, 129, 0.1); padding-bottom: 0.5rem;"><?= __('personal_info') ?></h4>
            ...
            <div class="form-grid form-grid-2">
                <div class="input-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="farmer_name" required class="input-field" placeholder="<?= __('ph_farmer') ?>">
                    </div>
                </div>
                ...
                <div class="input-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="mobile" required pattern="[0-9]{10}" title="10 digit mobile number" class="input-field" placeholder="<?= __('ph_mobile') ?>">
                    </div>
                </div>
                ...
                <div class="input-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="village" required class="input-field" placeholder="<?= __('ph_village') ?>">
                    </div>
                </div>
            </div>

            <h4 style="font-family: var(--font-headline); font-size: 1.125rem; font-weight: 700; color: var(--color-on-surface); margin: 2rem 0 1.5rem; border-bottom: 1px solid rgba(112, 120, 129, 0.1); padding-bottom: 0.5rem;"><?= __('farm_tech_details') ?></h4>
            
            <div class="form-grid form-grid-2">
                <div class="input-group">
                    <label class="form-label"><?= __('farm_name') ?> <span style="font-size: 0.625rem; color: var(--color-outline); margin-left: 0.25rem;">(<?= __('optional') ?>)</span></label>
                    <div class="input-wrapper">
                ...
                <div class="input-group">
                    <label class="form-label"><?= __('connection_no') ?> <span style="font-size: 0.625rem; color: var(--color-outline); margin-left: 0.25rem;">(<?= __('optional') ?>)</span></label>
                    <div class="input-wrapper">
