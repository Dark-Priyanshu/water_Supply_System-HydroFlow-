...
<div class="flex" style="justify-content: space-between; align-items: flex-end; margin-bottom: 2rem; margin-top: 1rem;">
    <div>
        ...
        <h2 style="font-size: 1.875rem; font-family: var(--font-headline); font-weight: 800; color: var(--color-on-surface); letter-spacing: -0.025em; margin-bottom: 0.5rem;"><?= __('add_new_motor') ?></h2>
        <p style="font-size: 1rem; color: var(--color-on-surface-variant); max-width: 40rem;"><?= __('motor_desc') ?></p>
    </div>
        ...
        <form action="../../controllers/motorController.php" method="POST" style="display: flex; flex-direction: column; gap: 1.5rem;">
            <div class="input-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" name="motor_name" required placeholder="<?= __('ph_motor') ?>" class="input-field">
                </div>
            </div>
            ...
            <div class="input-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="number" step="0.5" name="horsepower" required placeholder="<?= __('ph_hp') ?>" class="input-field">
                </div>
            </div>
            ...
            <div class="input-group">
                ...
                <div class="input-wrapper">
                    ...
                    <textarea name="location" rows="3" placeholder="<?= __('ph_location') ?>" class="input-field" style="padding-top: 0.75rem; min-height: 100px; resize: vertical;"></textarea>
                </div>
            </div>
