...
<div class="flex" style="justify-content: space-between; align-items: flex-end; margin-bottom: 2rem; margin-top: 1rem;">
    <div>
        <nav class="breadcrumb">
            ...
            <a href="supply_history.php"><?= __('supply_record') ?></a>
            <span class="material-symbols-outlined" style="font-size: 0.875rem;">chevron_right</span>
            <span style="color: var(--color-primary); font-weight: 500;"><?= __('new_entry') ?></span>
        </nav>
        <h2 style="font-size: 1.875rem; font-family: var(--font-headline); font-weight: 800; color: var(--color-on-surface); letter-spacing: -0.025em; margin-bottom: 0.5rem;"><?= __('record_supply') ?></h2>
    ...
    <div style="display: flex; flex-direction: column; gap: 1.5rem;">
        <div class="form-card" style="max-width: none;">
            <div class="form-body">
                <form action="../../controllers/supplyController.php" method="POST" id="supplyForm">
                    <h3 style="font-size: 1.125rem; font-weight: 700; font-family: var(--font-headline); color: var(--color-on-surface); margin-bottom: 2rem; border-left: 4px solid var(--color-primary); padding-left: 1rem;"><?= __('recording_details') ?></h3>
                    ...
                    <div class="form-grid form-grid-2">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <select name="customer_id" required class="input-field" style="appearance: none; cursor: pointer;">
                                    <option value=""><?= __('select_farmer') ?></option>
                        ...
                        <!-- Motor Selection -->
                        <div class="input-group">
                            <label class="form-label"><?= __('motor_used') ?? 'Motor Used' ?> <span class="required">*</span></label>
                            <div class="input-wrapper">
                                ...
                                <select name="motor_id" required class="input-field" style="appearance: none; cursor: pointer;">
                                    <option value=""><?= __('select_motor') ?></option>
                        ...
                        <!-- Date Picker -->
                        <div class="input-group">
                            <label class="form-label"><?= __('supply_date') ?> <span class="required">*</span></label>
                            <div class="input-wrapper">
                        ...
                        <div class="input-group">
                            <label class="form-label"><?= __('rate_per_hour') ?> (₹/hour) <span class="required">*</span></label>
                            <div class="input-wrapper">
                        ...
                        <!-- Time Range -->
                        <div class="input-group">
                            <label class="form-label"><?= __('start_time') ?> <span class="required">*</span></label>
                            <div class="input-wrapper">
                        ...
                        <div class="input-group">
                            <label class="form-label"><?= __('end_time') ?> <span class="required">*</span></label>
                            <div class="input-wrapper">
                                <span class="material-symbols-outlined input-icon">schedule</span>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
            <div class="card" style="padding: 1.5rem; background: var(--color-surface-container-low);">
                ...
                <h4 style="font-weight: 700; color: var(--color-on-surface); margin-bottom: 0.5rem; font-family: var(--font-headline);"><?= __('operating_protocol') ?></h4>
                <p style="font-size: 0.8125rem; color: var(--color-on-surface-variant); line-height: 1.5;"><?= __('op_protocol_desc') ?? 'Ensure the pressure valve is adjusted before starting high-HP motors to prevent pipe fatigue.' ?></p>
            </div>
            <div class="card" style="padding: 1.5rem; background: var(--color-surface-container-low);">
                <span class="material-symbols-outlined" style="font-size: 2rem; color: var(--color-secondary); margin-bottom: 0.75rem;">eco</span>
                <h4 style="font-weight: 700; color: var(--color-on-surface); margin-bottom: 0.5rem; font-family: var(--font-headline);"><?= __('conservation_tip') ?></h4>
                <p style="font-size: 0.8125rem; color: var(--color-on-surface-variant); line-height: 1.5;"><?= __('cons_tip_desc') ?? 'Early morning supply reduces evaporation by up to 22% compared to afternoon irrigation.' ?></p>
            </div>
        </div>
    </div>
            ...
            <div style="position: relative; z-index: 1;">
                <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 2rem;">
                    <p style="font-size: 0.625rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.15em; color: rgba(255,255,255,0.6); display: flex; align-items: center; gap: 0.5rem;">
                        <span style="width: 8px; height: 8px; border-radius: 50%; background: var(--color-secondary);"></span> <?= __('live_calculator') ?>
                    </p>
                ...
                <div style="display: flex; flex-direction: column; gap: 2rem;">
                    <div>
                        <p style="font-size: 0.75rem; color: rgba(255,255,255,0.6); margin-bottom: 0.5rem;"><?= __('total_duration') ?></p>
                    ...
                    <div style="padding-top: 1.5rem; border-top: 1px solid rgba(255,255,255,0.1);">
                        <p style="font-size: 0.75rem; color: rgba(255,255,255,0.6); margin-bottom: 0.5rem;"><?= __('estimated_amount') ?></p>
                        <div style="display: flex; align-items: baseline; gap: 0.5rem;">
                            ...
                            <span style="font-size: 0.625rem; font-weight: 700; text-transform: uppercase; color: rgba(255,255,255,0.4);"><?= __('gross') ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculate() {
        ...
        hoursDisplay.textContent = diffHrs.toFixed(2) + ' ' + '<?= __("hours") ?? "hrs" ?>';
